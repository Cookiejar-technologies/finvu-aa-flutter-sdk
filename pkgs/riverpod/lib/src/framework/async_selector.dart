...
class _AlwaysAliveAsyncSelector<Input, Output>
  ...
  _AlwaysAliveAsyncSelector({
    required ProviderListenable<AsyncValue<Input>> provider,
    required ProviderListenable<Future<Input>> future,
    required Output Function(Input) selector,
  }) : super(provider: provider, future: future, selector: selector);
}
