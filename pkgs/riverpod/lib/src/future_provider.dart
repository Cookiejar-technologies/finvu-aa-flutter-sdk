...
abstract class _FutureProviderBase<T> extends ProviderBase<AsyncValue<T>> {
  ...
  }) : super(dependencies: dependencies, allTransitiveDependencies: allTransitiveDependencies, name: name, argument: argument, from: from, debugGetCreateSourceHash: debugGetCreateSourceHash);
