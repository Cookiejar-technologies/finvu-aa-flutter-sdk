...
class StocksConsentPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final mfNotifier = ref.read(selectStocksNotifierProvider);
          ...
          children: [
            ...
            Align(
              ...
              child: AppButton(
                ...
                onPressed: (){
                  mfNotifier.stockConsentApprovalReq(Constants.accept, (){
            ...
            Align(
              ...
              child: AppTextButton(
                label: Labels.deny,
                onPressed: (){
                  mfNotifier.stockConsentApprovalReq(Constants.deny, (){
                    Navigator.pop(context);
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
